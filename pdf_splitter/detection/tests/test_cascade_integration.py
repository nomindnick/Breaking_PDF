...
@pytest.mark.skip(
    reason="SignalCombiner not implemented - cascade integration tests disabled"
)
class TestCascadeIntegration:
    ...
    def create_mock_detectors(self):
        ...
        def llm_detect(pages, context=None):
            ...
            if (
                ...
                and "target_pages" in context.document_metadata
            ):
    ...
    def test_cascade_with_real_detectors(self):
        ...
        with patch(
            "pdf_splitter.detection.llm_detector.LLMDetector._check_ollama_availability",
            return_value=False,
        ):
            with patch(
                "pdf_splitter.detection.llm_detector.LLMDetector._get_embedded_prompt",
                return_value="test",
            ):
    ...
    def test_cascade_detector_type_tracking(self):
        ...
        for result in results:
            ...
            assert result.detector_type in [
