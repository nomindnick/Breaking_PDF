...
from pdf_splitter.detection.base_detector import (BoundaryResult, BoundaryType,
...
Answer with just the type:"""
    ...
    def _apply_constrained_generation(
        self, response_text: str, constrained_vocab: List[str]
    ) -> str:
        """
        ...
        for token in constrained_vocab:
            ...
            if token_upper in response_upper:
